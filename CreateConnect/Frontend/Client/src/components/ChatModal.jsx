      ...
      >
        ...
        <div className={`flex items-center justify-between px-6 py-4 border-b ${
          isDarkTheme 
            ...
            : 'bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50 border-purple-200'
        }`}>
          <div className="flex items-center gap-4">
            <motion.div 
              ...
              className={`w-12 h-12 rounded-full flex items-center justify-center font-bold text-xl shadow-lg ${
                isDarkTheme 
                  ? 'bg-gradient-to-r from-indigo-600 to-[#783be8] text-white' 
                  : 'bg-gradient-to-r from-indigo-600 to-[#783be8] text-white'
              }`}
            >
            ...
            <div>
              ...
              <p className={`text-sm font-medium ${isDarkTheme ? 'text-purple-300' : 'text-[#783be8]'}`}>
            ...
            <motion.button
              ...
              className={`p-2 rounded-full transition shadow-lg ${
                isDarkTheme 
                  ...
                  : 'text-[#783be8] bg-purple-100 hover:bg-purple-200'
              }`}
        ...
        <div className={`flex-1 overflow-y-auto p-6 ${
          isDarkTheme 
            ...
            : 'bg-gradient-to-b from-indigo-50/30 via-purple-50/30 to-pink-50/30'
        }`}>
          {loading ? (
            <div className="flex items-center justify-center h-full">
              <motion.div
                ...
                className={`rounded-full h-16 w-16 border-4 ${
                  isDarkTheme 
                    ? 'border-[#783be8] border-t-transparent' 
                    : 'border-[#783be8] border-t-transparent'
                }`}
              />
            </div>
              ...
              <div className={`rounded-2xl p-10 text-center ${
                ...
                >
                  <MessageCircle className={`w-24 h-24 mx-auto mb-6 ${
                    isDarkTheme ? 'text-purple-400' : 'text-[#783be8]'
                  }`} />
                </motion.div>
              ...
              <div className="space-y-4">
                {Object.entries(messageGroups).map(([date, msgs]) => (
                  <div key={date}>
                    ...
                    >
                      <span className={`px-5 py-2 text-xs font-bold rounded-full shadow-lg ${
                        isDarkTheme 
                          ? 'bg-gradient-to-r from-purple-600 to-[#783be8] text-white' 
                          : 'bg-gradient-to-r from-indigo-600 to-[#783be8] text-white'
                      }`}>
                        {date}
                      </span>
                              ...
                              {isEditing ? (
                                <div className={`rounded-2xl p-4 ${
                                  ...
                                  <textarea
                                    ...
                                    className={`w-full px-3 py-2 border-2 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-[#783be8] text-sm ${
                                      isDarkTheme 
                                  ...
                                  <div className="flex gap-2 mt-3">
                                    <motion.button
                                      ...
                                      className="flex items-center gap-1 px-4 py-2 rounded-xl text-sm font-bold transition bg-gradient-to-r from-indigo-600 to-[#783be8] text-white hover:from-indigo-700 hover:to-purple-700 shadow-lg"
                                    >
                                  ...
                                  {isSender && (
                                    <div className={`absolute top-0 ${
                                      ...
                                      <motion.button
                                        ...
                                        className="p-2 bg-gradient-to-r from-indigo-600 to-[#783be8] text-white rounded-full hover:from-indigo-700 hover:to-purple-700 transition shadow-lg"
                                        title="Edit"
                                      >
                ...
                <div className="flex gap-2">
                  <motion.div 
                    ...
                    className={`w-2.5 h-2.5 rounded-full ${
                      isDarkTheme ? 'bg-purple-400' : 'bg-[#783be8]'
                    }`} 
                  />
                  <motion.div 
                    animate={{ y: [0, -10, 0] }}
          ...
          <div className="flex gap-3 items-center">
            <div className="flex-1 relative">
              <input
                ...
                className={`w-full px-5 py-4 pr-16 border-2 rounded-full focus:outline-none focus:ring-2 focus:ring-[#783be8] text-sm font-medium transition-all ${
                  isDarkTheme
              ...
              {newMessage.length > 900 && (
                <span className={`absolute right-5 top-1/2 -translate-y-1/2 text-xs font-bold ${
            ...
            <motion.button
              ...
              className="w-14 h-14 rounded-full transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center bg-gradient-to-r from-indigo-600 to-[#783be8] text-white hover:from-indigo-700 hover:to-purple-700 shadow-xl disabled:shadow-none"
            >
              {sending ? (
                <motion.div
                  animate={{ rotate: 360 }}
