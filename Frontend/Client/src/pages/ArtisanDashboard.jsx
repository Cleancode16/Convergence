...
import { Package, ShoppingCart, MessageSquare, Star, BarChart3, Settings, LogOut, Check, Clock, XCircle, AlertCircle, Users, Wallet, FileText, Award, Calendar, Menu, ChevronDown, Sparkles, ArrowRight, X } from 'lucide-react';
...
const ArtisanDashboard = () => {
          ...
          if (!statusData.data.profileComplete) {
            ...
            if (profileResponse.success) {
              ...
              if (profileResponse.data.verificationStatus === 'verified') {
                // Check if this is the first time seeing the verification
  ...
  // X-style Verified Badge Component
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      {/* Full-Width Scrolling Sections - Removed top padding, added to sections instead */}
      <div className="snap-y snap-mandatory h-screen overflow-y-scroll">
        {/* Stats Overview Section - First */}
        <section className="snap-start min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-white pt-28">
          <div className="absolute inset-0 bg-gradient-to-br from-indigo-600 to-purple-600 opacity-5"></div>
          
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center py-8">
            <div className="w-full">
              {/* Verification Banner - Only shown once */}
              {showVerificationBanner && profileData?.verificationStatus === 'verified' && (
                <div className="mb-8 p-6 bg-gradient-to-r from-blue-50 to-green-50 border-l-4 border-blue-500 rounded-xl shadow-lg animate-fade-in relative">
                  <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div className="bg-gradient-to-br from-purple-500 to-indigo-500 rounded-2xl p-6 text-white shadow-xl transform hover:scale-105 transition">
                  <Package className="w-10 h-10 mb-3 opacity-80" />
                  <p className="text-sm opacity-90 mb-1">Total Products</p>
                  <p className="text-4xl font-bold">24</p>
                </div>
                <div className="bg-gradient-to-br from-green-500 to-teal-500 rounded-2xl p-6 text-white shadow-xl transform hover:scale-105 transition">
                  <ShoppingCart className="w-10 h-10 mb-3 opacity-80" />
                  <p className="text-sm opacity-90 mb-1">Total Sales</p>
                  <p className="text-4xl font-bold">₹45,230</p>
                </div>
                <div className="bg-gradient-to-br from-blue-500 to-indigo-500 rounded-2xl p-6 text-white shadow-xl transform hover:scale-105 transition">
                  <Package className="w-10 h-10 mb-3 opacity-80" />
                  <p className="text-sm opacity-90 mb-1">Pending Orders</p>
                  <p className="text-4xl font-bold">7</p>
                </div>
                <div className="bg-gradient-to-br from-pink-500 to-purple-500 rounded-2xl p-6 text-white shadow-xl transform hover:scale-105 transition">
                  <Wallet className="w-10 h-10 mb-3 opacity-80" />
                  <p className="text-sm opacity-90 mb-1">Wallet Balance</p>
                  <p className="text-4xl font-bold">₹{walletBalance ? walletBalance.toLocaleString('en-IN') : '0'}</p>
                </div>
              </div>
              ...
              {workshops.length > 0 && (
                <div className="bg-white rounded-2xl shadow-xl p-8">
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-2xl font-bold text-gray-900">Your Active Workshops</h2>
                    <button
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {workshops.slice(0, 3).map((workshop) => (
                      <div
                        ...
                        className="border-2 border-gray-200 rounded-lg p-4 hover:shadow-lg transition cursor-pointer hover:border-purple-400"
                      >
